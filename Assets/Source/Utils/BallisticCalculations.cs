...
//
//    float BallisticRange(float speed, float gravity, float initial_height);
//
...
public class BallisticCalculations
{
    ...
    public static float BallisticRange(float speed, float gravity, float initial_height)
    {
        ...
        Debug.Assert(speed > 0 && gravity > 0 && initial_height >= 0, "BallisticCalculations.BallisticRange called with invalid data");
    ...
    public static int SolveBallisticArc(Vector3 proj_pos, float proj_speed, Vector3 target, float gravity, out Vector3 s0, out Vector3 s1)
    {
        // Handling these cases is up to your project's coding standards
        Debug.Assert(proj_pos != target && proj_speed > 0 && gravity > 0, "BallisticCalculations.SolveBallisticArc called with invalid data");
    ...
    public static int SolveBallisticArc(Vector3 proj_pos, float proj_speed, Vector3 target_pos, Vector3 target_velocity, float gravity, out Vector3 s0, out Vector3 s1)
    {
    ...
    public static bool SolveBallisticArcLateral(Vector3 proj_pos, float lateral_speed, Vector3 target_pos, float max_height, out Vector3 fire_velocity, out float gravity)
    {
        // Handling these cases is up to your project's coding standards
        Debug.Assert(proj_pos != target_pos && lateral_speed > 0 && max_height > proj_pos.y, "BallisticCalculations.SolveBallisticArcLateral called with invalid data");
    ...
    //
    // return (bool): true if a valid solution was found
    public static bool SolveBallisticArcLateral(Vector3 proj_pos, float lateral_speed, Vector3 target, Vector3 target_velocity, float max_height_offset, out Vector3 fire_velocity, out float gravity, out Vector3 impact_point)
    {
        // Handling these cases is up to your project's coding standards
        Debug.Assert(proj_pos != target && lateral_speed > 0, "BallisticCalculations.SolveBallisticArcLateral called with invalid data");
